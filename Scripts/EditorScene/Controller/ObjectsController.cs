...
{
    [SerializeField] private Transform objectsPanel;
    ...
    {
        loadedLights = FindTransform.FindChild(GameObject.Find("LoadedObjects").transform, "Lights");
        //TMP_InputField
    ...
    {
        target.name = inputDict["NameInputField"].text;
    }
